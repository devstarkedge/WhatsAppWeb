...
function Register() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-50 via-white to-cyan-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 bg-linear-to-br from-white/95 via-blue-50/50 to-purple-50/50 backdrop-blur-sm p-8 rounded-2xl shadow-2xl w-full max-w-lg border border-white/30 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex gap-4 mb-4">
              <div className="flex-1">
                <label className="block text-gray-700 text-sm font-semibold mb-3" htmlFor="firstName">
                  First Name
                </label>
                <input
                  type="text"
                ...
                />
                <p className="text-red-500 text-xs italic mt-1 min-h-4">{errors.firstName || ''}</p>
              </div>
              <div className="flex-1">
                <label className="block text-gray-700 text-sm font-semibold mb-3" htmlFor="lastName">
                  Last Name (Optional)
                </label>
                <input
                  type="text"
                ...
                />
                <p className="text-red-500 text-xs italic mt-1 min-h-4">{errors.lastName || ''}</p>
              </div>
            </div>
            <div className="mb-4">
            ...
            <div className="flex gap-4 mb-6">
              ...
              <div className="flex-1">
                ...
                />
                <p className="text-red-500 text-xs italic mt-1 min-h-4">{errors.confirmPassword || ''}</p>
              </div>
            </div>
            <div className="flex items-center justify-between">
              <button
                type="submit"
                className="w-full bg-linear-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold py-3 px-6 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg flex items-center justify-center space-x-2"
              >
                <span>Sign Up</span>
              </button>
            </div>
